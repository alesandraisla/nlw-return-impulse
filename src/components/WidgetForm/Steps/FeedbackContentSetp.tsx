...
export function FeedbackContentStep({
    ...
    //sabe quando a foto foi tirada por causa do useState
    ...
    return(
        <>
            ...
            <form className="my-4 w-full">
                <textarea 
                    className="min-w-[403px] w-full min-h-[112px] text-sm placeholder-zinc-400 text-zinc-100 border-zinc-600 bg-transparent rounded-md focus:border-brand-500 focus:ring-brand-500 focus:ring-1 resize-none focus:outline-none scrollbar scrollbar-thumb-zinc-700 scrollbar-track-transparent scrollbar-think"
